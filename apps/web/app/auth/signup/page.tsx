      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          <Link href="/" className="inline-flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-stone-900">Camper</span>
          </Link>
          <h1 className="mt-4 text-2xl font-bold text-stone-900">
            Create your account
          </h1>
          <p className="mt-1 text-sm text-stone-500">
            Start finding and booking campsites today
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  required
                  minLength={8}
                  className="w-full rounded-lg border border-stone-200 bg-stone-50 py-2.5 pl-10 pr-10 text-sm text-stone-900 placeholder:text-stone-400 focus:border-primary-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-100"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="flex w-full items-center justify-center rounded-xl bg-primary-600 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-primary-700 disabled:opacity-50"
            >
